...
def parse_args():    
    ...
    # parser.add_argument('-weights', type=str, default = '/data1/lihaocheng/deeplearning/paper1/dinov2/resultsp/MMNet_epoch35_0.873357399055655', help='the weights file you want to test')
    parser.add_argument('-weights', type=str, default = '/data1/lihaocheng/deeplearning/paper1/MoBaSF-dinov2/resultsp/MMNet_epoch35_0.8792773319039509', help='the weights file you want to test')
